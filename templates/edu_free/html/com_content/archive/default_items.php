		...
		<?php 
			...
			if ($params->get('show_category')) {
				...
				if ($this->params->get('link_category') && !empty($item->catid)) {
					$category = '<a href="' . RouteHelper::getCategoryRoute($item->catid) . '" itemprop="genre">' . $category . '</a>';
				}
			}
		?>
...
<?php if ($params->get('show_create_date') || $params->get('show_modify_date') || $params->get('show_hits')) : ?>
    <ul class="uk-list">
        <?php if ($params->get('show_create_date') && !empty($item->created)) : ?>
            <li>
                <time datetime="<?php echo HTMLHelper::_('date', $item->created, 'c'); ?>" itemprop="dateCreated">
                    <?php echo Text::sprintf('TPL_META_DATE_CREATED', HTMLHelper::_('date', $item->created, Text::_('DATE_FORMAT_LC3'))); ?>
                </time>
            </li>
        <?php endif; ?>

        <?php if ($params->get('show_modify_date') && !empty($item->modified)) : ?>
            <li>
