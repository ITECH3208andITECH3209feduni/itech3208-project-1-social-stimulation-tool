...
<?php if ($showHeader) : ?>
    <?php if ($params->get('show_title')) : ?>
        <h2 property="headline" class="el-title uk-h4 uk-margin-top uk-margin-remove-bottom">
            <?php if ($params->get('link_titles') && ($params->get('access-view') || $params->get('show_noauth', '0') == '1')) : ?>
                <a class="uk-link-heading" href="<?php echo Route::_(RouteHelper::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language)); ?>">
