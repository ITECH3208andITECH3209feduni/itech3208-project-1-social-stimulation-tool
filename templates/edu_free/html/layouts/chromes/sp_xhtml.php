...
$headerClass   = htmlspecialchars($params->get('header_class', 'uk-card-title uk-margin-remove-top') ?? "", ENT_COMPAT, 'UTF-8');
...
if ($module->content) {
	echo '<' . $moduleTag . ' class="uk-panel ' . $encodedModuleClassSfx . $moduleClass . '">';
	if ($module->showtitle) {
