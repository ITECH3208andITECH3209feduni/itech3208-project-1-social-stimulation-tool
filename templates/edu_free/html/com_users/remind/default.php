...
?>
<div class="tm-form-remind uk-flex uk-flex-center uk-flex-middle com-users-remind remind">
    ...
    <?php endif; ?>
    <form action="<?php echo Route::_('index.php?task=remind.remind'); ?>" method="post" id="user-registration" class="com-users-remind__form form-validate">
