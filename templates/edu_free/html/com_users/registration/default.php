...
?>
<div class="tm-form-registration com-users-registration registration">
    ...
    <form id="member-registration" action="<?php echo Route::_('index.php?task=registration.register'); ?>" method="post" class="com-users-registration__form form-validate" enctype="multipart/form-data">
        ...
        <div class="com-users-registration__submit control-group">
            <div class="controls">
                <button type="submit" class="com-users-registration__register uk-button uk-button-primary validate">
