...
<div id="tm-dialog" class="uk-offcanvas" uk-offcanvas="mode:<?php echo $dialog_offcanvas_mode; ?>;<?php echo $dialog_offcanvas_overlay . $dialog_offcanvas_flip; ?>">

    <div class="uk-offcanvas-bar uk-flex uk-flex-column<?php echo $dialog_menu_horizontally; ?>">

        <button class="uk-offcanvas-close uk-close-large" type="button" uk-close></button>

        <?php if ($params->get('dialog_center_vertical')): ?>
