...
<div id="tm-dialog" class="uk-offcanvas offcanvas-menu" uk-offcanvas="mode:<?php echo $dialog_offcanvas_mode; ?>;<?php echo $dialog_offcanvas_overlay . $dialog_offcanvas_flip; ?>">
