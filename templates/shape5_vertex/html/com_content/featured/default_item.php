...
<!-- Meta -->
<?php
	$author = (!$this->item->created_by ? 'Unknow User' : $this->item->author);
	$datePublished = $this->item->publish_up;
	$dateModified = $this->item->modified;
	$defaultLogo = JURI::base() . 'images/s5_logo.png';
	$mainEntityOfPage = $this->item->alias . '.html';
?>

<div class="element-invisible" style="display: none;">
	<meta itemprop="mainEntityOfPage" content="<?php echo $mainEntityOfPage; ?>">
    ...
    <div class="element-invisible" itemprop="logo" itemscope itemtype="https://schema.org/ImageObject">
      <meta itemprop="url" content="<?php echo $defaultLogo; ?>">
    </div>
	</div>

	<?php if (!$params->get('show_publish_date')): ?>
		<meta itemprop="datePublished" content="<?php echo $datePublished; ?>" />
	<?php endif; ?>

	<?php if (!$params->get('show_modify_date')): ?>
		<meta itemprop="dateModified" content="<?php echo $dateModified; ?>" />
	<?php endif; ?>
	...
	<?php if (!isset($images->image_intro) || empty($images->image_intro)): ?>
		...
		<div class="element-invisible" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
		  <img itemprop="url contentUrl" alt="Alt text" src="<?php echo $defaultLogo; ?>">
		</div>
	<?php endif; ?>
</div>
...
<?php if ($this->item->state == 0 || strtotime($this->item->publish_up) > strtotime(JFactory::getDate())
	...
	|| ((strtotime($this->item->publish_down) < strtotime(JFactory::getDate())) && !is_null($this->item->publish_down))) : ?>
...
<?php if ((strtotime($this->item->publish_down) < strtotime(JFactory::getDate())) && !is_null($this->item->publish_down)) : ?>
