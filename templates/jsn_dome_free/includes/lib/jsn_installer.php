 ...
 * @version   $Id: jsn_installer.php 12394 2012-05-03 03:47:58Z tuyetvt $
 */
...
class JSNInstaller extends JInstaller
{
	...
	public function setAdapter($name, &$adapter = null, $options = Array())
	{
		...
		{
			include_once dirname(__FILE__).DS.'adapters'.DS.strtolower($name).'.php';
	...
	public function parseFiles($element, $cid=0, $oldFiles=null, $oldMD5=null)
	{
		...
		if (!is_null($oldFiles))
		{
			...
			{
				$deleted_file = $destination.DS.str_replace('/', DS, $value);
