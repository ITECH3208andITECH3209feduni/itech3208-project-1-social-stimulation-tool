...
class JSNAjax
{
	...
	function _setTmplInfo()
	{
		...
		$template_name	  			= StringHelper::strtolower($this->_template_name);
	...
	function checkVersion()
	{
		...
		$exploded_template_name	= explode('_', StringHelper::strtolower($this->_template_name));
	...
	function manualUpdateTemplate()
	{
		...
		$package_path		= JPATH_ROOT.DS.'tmp'.DS.$package_name;
