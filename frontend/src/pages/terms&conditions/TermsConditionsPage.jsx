    ...
    const sections = [
        ...
        },
        {
            ...
            highlights: [
                {
                    text: "Grant Meredith",
                    url: "https://www.federation.edu.au/research/find-an-expert/grant-meredith/",
                },
                {
                    text: "Telematics Trust",
                    url: "https://www.telematics.org.au/",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            color: "brand.500",
            items: [
                "You may use the Scenari-Aid web site for research purposes under the following conditions:",
            ],
            subItems: [
                "Your research must be approved by an appropriately accredited Ethics Committee",
                "You describe the purpose, aims and methodology of your project",
                "You request permission from Grant Meredith.",
            ],
            highlights: [
                {
                    text: "Grant Meredith",
        ...
        },
        {
            ...
            color: "brand.500",
            items: [
                "Scenari-Aid web site can be used for educational purposes under the following conditions:",
            ],
            subItems: [
                "You are registered as an educational services provider with government authorities in your jurisdiction",
                "You describe the context of the use of the Scenari-Aid web site",
                "You request permission from Grant Meredith.",
            ],
            highlights: [
                {
